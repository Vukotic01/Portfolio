...
function WipeUp({ children, delay = 0, className }: { children: React.ReactNode; delay?: number; className?: string }) {
  return (
...
export function AboutContent() {
  ...
  return (
    <PageWrapper>
      {/* Intro — no entrance animation, visible immediately */}
      ...
      <section className="py-14 md:py-20 px-4 sm:px-6 border-b border-border">
        <div className="max-w-6xl mx-auto">
          <FadeUp className="text-sm font-medium text-accent uppercase tracking-widest mb-3">
            {t.about.academicBg}
          </FadeUp>

          <WipeUp delay={0.05} className="font-display text-3xl font-bold text-text-primary mb-10 section-heading">
            {t.about.education}
          </WipeUp>
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 border-b border-border">
        <div className="max-w-6xl mx-auto">
          ...
          <WipeUp delay={0.05} className="font-display text-3xl font-bold text-text-primary mb-10 md:mb-12 section-heading">
            {t.about.skillsTitle}
          </WipeUp>
